module.exports = {
    ...
    CHARCODE_LATINA     : Buffer.from([0x1b, 0x74, 0x12]), // Latin America
    ...
    // BARCODE_CODE128  : Buffer.from([0x1d, 0x6b, 0x04]), // Barcode type CODE39
    BARCODE_CODE128_TEXT_1  : Buffer.from([0x1d, 0x48, 1]), // printer data above the bar code
    BARCODE_CODE128_TEXT_2  : Buffer.from([0x1d, 0x48, 2]), // printer data below the bar code
    BARCODE_CODE128_TEXT_3  : Buffer.from([0x1d, 0x48, 3]), // printer data both above and below the bar code
