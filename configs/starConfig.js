module.exports = {
    ...
    // Char code table
    CHARCODE_PC437  : Buffer.from([0x1b, 0x74, 0x00]), // USA: Standard Europe
    CHARCODE_JIS    : Buffer.from([0x1b, 0x74, 0x01]), // Japanese Katakana
    CHARCODE_PC850  : Buffer.from([0x1b, 0x74, 0x02]), // Multilingual
    CHARCODE_PC860  : Buffer.from([0x1b, 0x74, 0x03]), // Portuguese
    CHARCODE_PC863  : Buffer.from([0x1b, 0x74, 0x04]), // Canadian-French
    CHARCODE_PC865  : Buffer.from([0x1b, 0x74, 0x05]), // Nordic
    CHARCODE_WEU    : Buffer.from([0x1b, 0x74, 0x06]), // Simplified Kanji, Hirakana
    CHARCODE_GREEK  : Buffer.from([0x1b, 0x74, 0x07]), // Simplified Kanji
    CHARCODE_HEBREW : Buffer.from([0x1b, 0x74, 0x08]), // Simplified Kanji
    CHARCODE_PC1252 : Buffer.from([0x1b, 0x74, 0x11]), // Western European Windows Code Set
    CHARCODE_PC866  : Buffer.from([0x1b, 0x74, 0x12]), // Cirillic //2
    CHARCODE_PC852  : Buffer.from([0x1b, 0x74, 0x13]), // Latin 2
    CHARCODE_PC858  : Buffer.from([0x1b, 0x74, 0x14]), // Euro
    CHARCODE_THAI42 : Buffer.from([0x1b, 0x74, 0x15]), // Thai character code 42
    CHARCODE_THAI11 : Buffer.from([0x1b, 0x74, 0x16]), // Thai character code 11
    CHARCODE_THAI13 : Buffer.from([0x1b, 0x74, 0x17]), // Thai character code 13
    CHARCODE_THAI14 : Buffer.from([0x1b, 0x74, 0x18]), // Thai character code 14
    CHARCODE_THAI16 : Buffer.from([0x1b, 0x74, 0x19]), // Thai character code 16
    CHARCODE_THAI17 : Buffer.from([0x1b, 0x74, 0x1a]), // Thai character code 17
    CHARCODE_THAI18 : Buffer.from([0x1b, 0x74, 0x1b]), // Thai character code 18
